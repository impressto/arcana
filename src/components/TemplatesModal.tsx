...
import { X, Download, Copy, ExternalLink, FileText, BookOpen, Lightbulb } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-4 rounded-lg border border-blue-200">
              ...
              <p className="text-blue-700 text-sm mb-3">
                Download complete template pack with usage guides
              </p>
              <button
            ...
            <div className="bg-gradient-to-r from-green-50 to-green-100 p-4 rounded-lg border border-green-200">
              ...
              <p className="text-green-700 text-sm mb-3">
                Complete guide for using templates with AI agents
              </p>
              <button
                onClick={() => window.open(`${import.meta.env.VITE_TEMPLATES_BASE_URL || '/templates'}/README.md`, '_blank')}
